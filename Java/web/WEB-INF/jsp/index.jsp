    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <body>
                    ...
                    <div class="col-1 me-4 h-100">
                        <div
                            ...
                            <div class="col border-end border-1 border-light-subtle d-flex h-100 w-50">
                                <a href="#" style="font-size: 20px;" class="w-100 d-flex justify-content-center align-items-center">
                                    <i class="fa-solid fa-shopping-cart"></i>
                                </a>

                            </div>
                            <div class="col border-start border-1 border-light-subtle d-flex h-100 w-50">
                                <a href="./login" style="font-size: 20px;" class="w-100 d-flex justify-content-center align-items-center">
            ...
            <main>
                ...
                <div class="container row m-auto gap-3" style="max-height: 30vh; height:30vh;">
                    <c:forEach items="${produtos}" var="produto" end="12">                        
                        <div class="card col-3 m-auto" style="width: 20vw;">
                            <div class="card-body">
                                <h5 class="card-title mt-0;"><p class="m-0" style="font-size: 0.6rem; color:grey;">${produto.valor}</p>${produto.valorFinal}</h5>
                                <p class="card-text">${produto.categoria}: ${produto.nome}</p>
